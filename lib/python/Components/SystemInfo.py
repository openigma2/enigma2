...
def setBoxInfoItems():
	...
	BoxInfo.setItem("ISDREAMBOX", model in ("dm7080", "dm820", "dm900", "dm920"))
	...
	BoxInfo.setItem("HaveCISSL", fileCheck("/etc/ciplus/customer.pem") and fileCheck("/etc/ciplus/device.pem"))
	...
	BoxInfo.setItem("DMHDMI", model in ("dm7080", "dm820", "dm900", "dm920"))
	...
	BoxInfo.setItem("DreamBoxAudio", model in ("dm7080", "dm820", "dm900", "dm920"))
	...
	BoxInfo.setItem("FbcTunerPowerAlwaysOn", model in ("dm900", "dm920", "vusolo4k", "vuduo4k", "vuduo4kse", "vuultimo4k", "vuuno4k", "vuuno4kse"))
