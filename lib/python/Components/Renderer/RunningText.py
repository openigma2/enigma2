# - RunningText Renderer /usr/lib/enigma2/python/Components/Renderer/RunningText.py
# - This renderer can be used in OLED display with dmm oe2.0 images
#   render="RunningText" options="movetype=running,direction=left,startpoint=0,steptime=10,startdelay=1000,noWrap"
